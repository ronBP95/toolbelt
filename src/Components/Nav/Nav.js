...
export default function Nav() {
  return (
    <div class="flex justify-between items-center w-full min-w-fit h-20 bg-gray-800">
        ...
        <div class="flex">
            <button type="button" class="hidden sm:flex text-white bg-red-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-7 transition duration-200 hover:scale-110 hover:bg-red-700 ">Sign In</button>
