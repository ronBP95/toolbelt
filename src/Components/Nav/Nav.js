...
export default function Nav() {
  return (
    <div class="flex justify-between items-center w-full min-w-fit h-20 bg-gray-800">
        ...
        <div class="flex">
            <button type="button" class="hidden sm:flex text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-7 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Sign In</button>
