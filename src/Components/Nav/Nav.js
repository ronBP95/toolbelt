...
export default function Nav() {
  return (
    <div class="flex fixed justify-between items-center w-full min-w-fit h-20 bg-gray-800">
        ...
        <div class="flex ml-8">
            <button type="button" class="hidden sm:flex text-white bg-sky-600 rounded-lg text-sm w-fit px-6 py-2.5 text-center mr-5 transition duration-200 hover:scale-110 hover:bg-red-700 ">Log In</button>
            <button type="button" class="hidden sm:flex text-white bg-red-600 rounded-lg text-sm w-fit px-6 py-2.5 text-center mr-7 transition duration-200 hover:scale-110 hover:bg-red-700 ">Sign Up</button>
